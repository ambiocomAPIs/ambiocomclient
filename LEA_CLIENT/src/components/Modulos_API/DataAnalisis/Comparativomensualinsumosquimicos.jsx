...
const Comparativomensualinsumosquimicos = () => {
  ...
  const [tituloGrafico, setTituloGrafico] = useState("Gráfico Comparativo");
  const [serieActual, setSerieActual] = useState("Serie Actual");
  const [serieAnterior, setSerieAnterior] = useState("Serie Anterior");
  ...
  const handleGuardar = async () => {
    try {
      ...
      await axios.post("https://ambiocomserver.onrender.com/api/graficainsumoskgoh/guardar", {
        produccionActual,
        produccionAnterior,
        mesDeCierre,
        mesComparar,
  ...
  return (
    <Box sx={{ width: "98vw", minHeight: "100vh", p: 4, bgcolor: "#f9f9fb" }}>
      <Typography
        ...
        mt={5}
      >
        Comparativo Mensual de Insumos Químicos
      </Typography>
            ...
            <Box sx={{ width: "100%", height: "60vh" }}>
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis tickFormatter={(value) => Number(value).toFixed(6)}>
                    <Label
