...
import ModalFilterData from './utils_codificacionColores/ModalFilterData';
...
const CodificacionDeColoresComponent = React.memo(() => {
  ...
  useEffect(() => {
    ...
    axios.get('https://ambiocomserver.onrender.com1/api/tableColors/dataColors')
      .then(response => {
    ...
    const handleBlur = async () => {
      ...
      try {
        const response = await axios.put(
          'https://ambiocomserver.onrender.com1/api/tableColors/dataColorsreplaceall',
          [editedRow]
        );
  ...
  const agregarDataFila = () => {
    ...
    axios.post('https://ambiocomserver.onrender.com1/api/tableColors/dataColors', newFile)
      .then(response => {        
...
const deleteRowData = (rowId) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      axios.delete(`https://ambiocomserver.onrender.com1/api/tableColors/dataColors/${rowId}`)
        .then(() => {
