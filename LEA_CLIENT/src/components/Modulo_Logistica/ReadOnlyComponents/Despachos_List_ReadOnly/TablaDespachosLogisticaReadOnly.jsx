...
export default function TablaDespachosLogisticaReadOnly() {
  ...
  const copiarTablaPortapapeles = () => {
    ...
    const rows = medicionesFiltradas.map((row) => [
      row.fecha,
      ...columnas
        .filter((c) => columnasVisibles.includes(c.key))
    ...
    <Box sx={{ p: 0 }}>
      ...
      >
        ...
        >
          ...
          >
            DESPACHO DE ALCOHOLES READ ONLY
          </Typography>
        </Box>
        ...
        >
          ...
          >
            ...
            <Tooltip title={ordenFechaAsc ? "Ver recientes" : "Ver antiguos"}>
              ...
              >
                <SortByAlphaIcon sx={{ color: ordenFechaAsc ? "blue" : "inherit" }} />
              </IconButton>
            </Tooltip>
            ...
            <ExcelDownloadButton
              ...
              filename={`DespachoAlcoholes_${new Date().toISOString().slice(0, 10)}.xlsx`}
            />
        ...
        <Table size="small" stickyHeader>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">Responsable de recibo</TableCell>
            </TableRow>
          </TableHead>
