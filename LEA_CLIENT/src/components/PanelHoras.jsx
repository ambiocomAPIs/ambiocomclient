...
const PanelHoras = () => {
  ...
  const fetchDatos = async () => {
    try {
      ...
      const response = await axios.get('https://ambiocomserver.onrender.com1/api/usuarios/obtenerUsuarioHorasExtras', {
        params: { mes, anio }
      });
  ...
  const agregarUsuario = async () => {
    ...
    try {
      const response = await axios.post('https://ambiocomserver.onrender.com1/api/usuarios/crearUsuarioHorasExtras', nuevoUsuario);
