...
const CodificacionDeColoresComponent = React.memo(() => {
  ...
  useEffect(() => {
    ...
    axios.get('http://ambiocomserver.onrender.com/api/tableColors/dataColors')
      .then(response => {
    ...
    const handleBlur = async () => {
      ...
      try {
        const response = await axios.put(
          'http://ambiocomserver.onrender.com/api/tableColors/dataColorsreplaceall',
          [editedRow]
        );
  ...
  const agregarDataFila = () => {
    ...
    axios.post('http://ambiocomserver.onrender.com/api/tableColors/dataColors', newFile)
      .then(response => {        
...
const deleteRowData = (rowId) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      axios.delete(`http://ambiocomserver.onrender.com/api/tableColors/dataColors/${rowId}`)
        .then(() => {
