...
const DetallesMovimientosDeTanquesJornaleros = ({ open, onClose }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://ambiocomserver.onrender.com1/api/reportar/veroperacionesdetanques');
  ...
  return (
    <Dialog open={open} onClose={() => onClose(false)} maxWidth="md" fullWidth>
      ...
      <DialogActions>
        <Button onClick={exportarMovimientosExcel} endIcon={<img src={"/Icons/excelIcon.png"} alt="Excel Icon" style={{ width: 35, height: 35 }} />} color="success">Exportar</Button>
