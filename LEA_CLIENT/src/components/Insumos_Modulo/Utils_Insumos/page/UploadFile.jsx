...
const FileUpload = ({ uploadrowId }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
        ...
        const checkResponse = await axios.get(`https://ambiocomserver.onrender.com1/api/pdfs/${rowId}`);
        ...
        if (checkResponse.status === 200) {
            ...
            if (result.isConfirmed) {
                ...
                const replaceResponse = await axios.post('https://ambiocomserver.onrender.com1/api/pdfs/update', replaceFormData, {
                    headers: {
        ...
        if (error.response && error.response.status === 404) {
            ...
            const uploadResponse = await axios.post('https://ambiocomserver.onrender.com1/api/pdfs/upload', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
