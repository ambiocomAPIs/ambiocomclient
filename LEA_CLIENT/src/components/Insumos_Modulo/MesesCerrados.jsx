...
import FileUpload from '../Insumos_Modulo/Utils_Insumos/page/UploadFile';
import SpeedDialComponent from '../../utils/speedDial/SpeedDial';
import DataTableChartModalInventariovsSAP from '../Insumos_Modulo/Utils_Insumos/Modals_Insumos/DataTableChartModalInventariovsSAP'
import DataTableChartModalCostMensualMesesCerrados from '../Insumos_Modulo/Utils_Insumos/Modals_Insumos/DataTableChartModalCostMensualMesesCerrados';
...
const MesesCerrados = React.memo(() => {
  ...
  const filtrarConsumo = () => {
    ...
    axios.get('https://ambiocomserver.onrender.com1/api/cierreMes/data')
      .then(response => {
